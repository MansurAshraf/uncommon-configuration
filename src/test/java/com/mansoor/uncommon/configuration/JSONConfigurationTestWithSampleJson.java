 ...
 * @since 3/17/12
 */
public class JSONConfigurationTestWithSampleJson {
    ...
    public void setUp() throws Exception {
        configuration=new JsonConfiguration (5, TimeUnit.MINUTES);
        configuration.load(this.getClass().getResource("/sample.json").getPath());
    }
    ...
    public void testName() throws Exception {
        ...
        configuration.save("/tmp/books.json");
    }
}
